    ...
    <div style={{width:'100vw', height:'100vh', display:'flex', justifyContent:'center', alignItems:'center', border:'2px solid black'}}>
     ...
     <Box
      ...
      >
        ...
        {isAdmin?<button onClick={handleProductSubmit} style={buttonStyles}>Update Product as Admin</button>:<button onClick={handleProductChange} style={buttonStyles}>Submit changes for approval</button>}
