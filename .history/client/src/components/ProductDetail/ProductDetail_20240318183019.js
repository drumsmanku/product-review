...
import 'react-image-crop/dist/ReactCrop.css'; // Import react-image-crop styles
...
function ProductDetail() {
  ...
  const [crop, setCrop] = useState({ aspect: 1 / 1 }); // Initialize crop state
  ...
  const handleProductChange=()=>{
    axios.post('http://localhost:4000/products/review', {
