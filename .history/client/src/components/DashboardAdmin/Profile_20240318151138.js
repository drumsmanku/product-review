...
function Profile() {
  ...
  return (
    <div className="vh-40" style={{ backgroundColor: '#FFFFFF', width:'100%', height:'100%' }}>
      <MDBContainer style={{height:'80%'}}>
        <MDBRow style={{height:'50%'}} className="justify-content-center">
          <MDBCol md="9" lg="8" xl="7" className="mt-5">
            <MDBCard style={{ borderRadius: '15px', height:'90%',  }}>
