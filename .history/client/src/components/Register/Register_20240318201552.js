...
function Register() {
  ...
  const signup = (event) => {
    ...
    axios.post('https://product-review-y121.onrender.com/signup', user)
      .then(res => {
      ...
      <form className={styles.form}>
        ...
        <div className={styles.inputContainer}>
          ...
          <div style={DivStyles1}>
            <label htmlFor="isAdmin" style={{ fontWeight: 600, fontSize: 'small' }}>Are you an admin?</label>
            <input style={{marginLeft:'1rem'}} type="checkbox" name="isAdmin" checked={user.isAdmin} onChange={handleCheckboxChange}  />
          </div>
        </div>
        <div style={{width:'100%', display:'flex', justifyContent:'center'}}>
          <p style={{width:'85%', textAlign:'left', fontWeight:600,fontSize:'small', marginTop:0}}>By enrolling your mobile phone number, you consent to receive automated security notifications via text message from Product Review. Message and data rates may apply.
          </p>
        </div>
        ...
        <div style={{width:'100%', display:'flex', justifyContent:'center', marginTop:'1rem'}}>
          <p style={{width:'85%', textAlign:'left',fontSize:'small',  marginTop:0}}>By continuing, you agree to Product Review's privacy notice and conditions of use.
          </p>
        </div>
