...
function ProductDetailOnAdmin() {
  ...
  const handleAccept=()=>{
    axios.put(`https://product-review-y121.onrender.com/products/review/${product._id}`,{
    ...
    axios.put(`https://product-review-y121.onrender.com/products/${product.id}`,{
      productName:productFields.productName,
      price:productFields.price,
      image:productFields.image,
      productDescription:productFields.productDescription,
  ...
  const handleReject=()=>{
    axios.patch(`https://product-review-y121.onrender.com/products/review/${product._id}/status`,{status:"rejected"})
